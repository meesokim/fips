...
set(FIPS_ANDROID 1)
set(FIPS_POSIX 1)
set(FIPS_ANDROID_COMPILER_FLAGS "-Wno-expansion-to-defined")
set(FIPS_ANDROID_COMPILER_FLAGS_CXX)
set(FIPS_ANDROID_COMPILER_FLAGS_C)
...
# add fips specific flags
list(APPEND ANDROID_COMPILER_FLAGS ${FIPS_ANDROID_COMPILER_FLAGS})
list(APPEND ANDROID_COMPILER_FLAGS_CXX ${FIPS_ANDROID_COMPILER_FLAGS_CXX})
list(APPEND ANDROID_COMPILER_FLAGS_C ${FIPS_ANDROID_COMPILER_FLAGS_C})
...
if(NOT IS_DIRECTORY "${ANDROID_NDK}/platforms/${ANDROID_PLATFORM}")
  message(FATAL_ERROR "Invalid Android platform: ${ANDROID_PLATFORM}. ${ANDROID_NDK}")
